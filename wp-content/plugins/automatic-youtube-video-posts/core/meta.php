...
function WP_ayvpp_save_post($i) {
	...
	if(!empty($_POST['_ayvpp_video'])) {
		update_post_meta($i,'_ayvpp_video',sanitize_text_field($_POST['_ayvpp_video']));
		update_post_meta($i,'_ayvpp_video_url',sanitize_text_field($_POST['_ayvpp_video_url']));
		update_post_meta($i,'_ayvpp_author',sanitize_text_field($_POST['_ayvpp_author']));
...
function WP_ayvpp_box() {
	...
	if(get_post_meta($_GET['post'],'_ayvpp_video',true)) {
