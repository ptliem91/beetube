...
var beeTube = {
	...
	loopViewSwitcher: function() {
		$('.loop-actions .view a').on('click', function(e) {
			...
			//jQuery('.switchable-view').trigger('classChange');
...
$(document).ready(function(){	
	beeTube.init();
	jQuery("#getEmbed").on("click",function(){
		jQuery(this).next("textarea#embedCode").val("<iframe name='BeeTube Emebd' src='"+jQuery(this).prev("input#embedUrl").val()+"' width='100%' height='100%' frameborder='0'></iframe>").slideToggle();
	})
});
